...
def save_checkpoint_withtime(epoch, model, optimizer, losses):
    """
    Save model checkpoint.
    ...
    filename = 'F:/code/pyPro/ssd1-20220106/dive-into-cv-pytorch/code/chapter03_object_detection_introduction' \
               '/tiny_detector_demo/checkpoint/checkpoint_loss_' + str(losses) + '.pth.tar '
    torch.save(state, filename)


def save_checkpoint_withprune(epoch, model, optimizer, losses):
    """
    Save model checkpoint.
    ...
    filename = 'F:/code/pyPro/ssd1-20220106/dive-into-cv-pytorch/code/chapter03_object_detection_introduction' \
               '/tiny_detector_demo/checkpoint/checkpoint_prune_loss_' + str(losses) + '.pth.tar '
    torch.save(state, filename)
